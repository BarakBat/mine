...
def parse_opts():
    ...
    parser.add_argument(
        '--root_path',
        default='C:\\Users\\bbattach\\PycharmProjects\\transformer_pytorch',
        type=str,
    ...
    parser.add_argument(
        ...
        default='1000',
        type=int,
        help='Feature vector size, default = 256')
    parser.add_argument(
        '--feature_size_ds',
        default='256',
        type=int,
        help='between the feature extractor and the attention we downsample, this is to what dimenstion to downsample')
    parser.add_argument(
        '--video_path',
        default='jpg',
        type=str,
    ...
    parser.add_argument(
        '--annotation_path',
        default='annotation_dir_path\\hmdb51_1.json',
        type=str,
    ...
    parser.add_argument(
        ...
        default='mobilenet',
        type=str,
        help='There is only one model for now')
    parser.add_argument(
        '--model_depth',
        default=1,
        type=int,
        help='Depth of resnet (1 only for now)')
