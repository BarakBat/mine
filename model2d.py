...
from PayAttention2D import PayAttention2D
...
class BNet(nn.Module):
    def __init__(self,opt):
        ...
        ###attention####
        self.attention = PayAttention2D(opt.feature_size_ds, opt.frame_size, self.batch_size, opt.frames_sequence,opt.attention_arch)
